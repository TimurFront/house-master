...
$(document).ready(function () {
	...
	$(".header__container-lang").click(function() {
		$(".header__container-lang-ru").toggleClass("active")
		$(".header__container-lang-en").toggleClass("active")
	});

	// SWIPERS

	var swiper = new Swiper(".zap__container-swiper", {
		spaceBetween: 64,
        pagination: {
	...
	var swiper = new Swiper(".chert-swiper", {
		spaceBetween: 64,
        pagination: {
          el: ".swiper-pagination",
          type: "fraction",
	...
	var swiper = new Swiper(".shem-swiper", {
        slidesPerView: 3,
        spaceBetween: 23,
        navigation: {
	  ...
	  var swiper = new Swiper(".five__swiper-swiper", {
		slidesPerView: 1,
        pagination: {
          el: ".swiper-pagination",
          type: "fraction",
	...
	$('.phone-mask').mask("+ 7 000 000 00 00");
	 ...
	 $('.cta__container-form').each(function() {
        var it = $(this);
         it.validate({
			rules: {
				name: {
	...
	$('.header__container-menu').click(function() {
		$(".header-blur").addClass('active')
		$(".header-m").addClass('active')
		$("html").addClass('no-scroll')
	})
	
	$('.header-blur').click(function() {
		$(".header-blur").removeClass('active')
	...
	var swiper = new Swiper(".dom-swiper", {
        navigation: {
          nextEl: ".swiper-button-next",
          prevEl: ".swiper-button-prev",
        },
	...
	var swiper1 = new Swiper(".chert-swiper", {
        navigation: {
          nextEl: ".swiper-button-next1",
          prevEl: ".swiper-button-prev1",
        },
	...
	$(".btn-chert").click(function() {
		$(".dom-swiper").removeClass("active")
		$(".chert-swiper").addClass("active")
	})
	
	$(".btn-img").click(function() {
		$(".dom-swiper").addClass("active")
		$(".chert-swiper").removeClass("active")
	})

	$('.phone-mask').mask("+ 7 000 000 00 00");

	$('.cta__content-form').each(function() {
        var it = $(this);
         it.validate({
			rules: {
				phone: {
	...
	$('.vst__bot-form').each(function() {
	 ...
	 $('.popup-content-form').each(function() {
        var it = $(this);
         it.validate({
			rules: {
				phone: {
	...
	$('.dop__container-item-content-more').click(function() {
		$(this).closest(".dop__container-item-content").find('.dop__hide').addClass('active')
		$(this).remove()	
	})

	$('.first__container-gal').click(function() {
		$('.galpop').removeClass('hide');
    	$('html').addClass('no-scroll');
	})

	$('.icon__gclose').click(function() {
		$('.galpop').addClass('hide');
    	$('html').removeClass('no-scroll');
	})

	if ($(window).width() < 1881) {
		$('.galpop__container-item').addClass('m-bg-cont')
	}
	...
	if ($(window).width() < 1541) {
		$('.about__content').addClass('wrapper')
		$('.dom__container').addClass('wrapper')
		$('.cta__content').addClass('wrapper')
	}
	
	$(".inv__blocks-block").mouseover(function(){
		var invid = $(this).attr("data-inv")
		$('#' + invid).addClass('active')
	});

	$(".inv__blocks-block").mouseout(function(){
		var invid = $(this).attr("data-inv")
		$('#' + invid).removeClass('active')
	});

	$('.dom__top-left').click(function() {
		$(this).addClass('active')
		$('.dc1').addClass('act')
		$('.ds1').addClass('act')
		$('.cs1').addClass('act')
		...
		$('.dom__top-right').removeClass('active')
		$('.dc2').removeClass('act')
		$('.ds2').removeClass('act')
		$('.cs2').removeClass('act')
	})
	
	$('.dom__top-right').click(function() {
		$(this).addClass('active')
		$('.dc2').addClass('act')
		$('.ds2').addClass('act')
		$('.cs2').addClass('act')
		...
		$('.dom__top-left').removeClass('active')
		$('.dc1').removeClass('act')
		$('.ds1').removeClass('act')
		$('.cs1').removeClass('act')
	})

	$('.tmenu__container-menu').click(function() {
		$('.tmenu').removeClass('hide')
    	$('html').addClass('no-scroll');
	})
	$('.tmenu-bl').click(function() {
		$('.tmenu').addClass('hide')
    	$('html').removeClass('no-scroll');
	})
	$('.tmenu__container-close').click(function() {
		$('.tmenu').addClass('hide')
    	$('html').removeClass('no-scroll');
	})
